...
func CreateEntity(v EntityData) (e Entity) {
	...
	e = Entity{
		...
		GLA:            Unit{},
		Tax:            Tax{MinValue: v.WOZpercent, LandValue: v.Landvalue, UsablePeriod: v.HoldPeriod, RETT: .07, CIT: map[float64]float64{}, VAT: 0},
...
func (e *Entity) UpdateEntity() {
	...
	temp := Entity{
		...
		GLA: Unit{
			...
			Default:         Default{Hazard: v.GLA.Default.Hazard, NumberOfDefaults: 0},
		...
		Tax:            Tax{MinValue: v.WOZpercent, LandValue: v.Landvalue, UsablePeriod: v.HoldPeriod, RETT: v.RETT, CIT: map[float64]float64{}, VAT: v.VAT},
		COA:            map[int]FloatCOA{},
		Valuation:      Valuation{EntryYield: v.EntryYield, YieldShift: v.YieldShift, ExitYield: v.ExitYield, AcqFees: map[string]Fee{}, DispFees: map[string]Fee{}, IncomeCapSetup: FloatCOA{TotalERV: 1}, IncomeDeduction: FloatCOA{}},
		TableHeader:    HeaderType{},
		Table:          []TableJSON{},
