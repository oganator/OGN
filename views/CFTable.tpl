[[define "CFTable"]]
    <table class="table table-hover rounded tableFixHead" id="CFTable">
        <thead>
            <tr>
            <th scope="col"></th>
            [[$name := .entity.Name]]
        ...
        <tbody>
            [[range .entity.Table]]
            [[$table := .]]
                <tr id="[[.COA]] row" [[if .Selected]] class="fifth-bg" [[end]]>
                    <th style="min-width: 250px; position: sticky; Left: 0px;" ng-dblclick='selectForChart("[[.COA]]")' scope="row">[[.COA]]</th>
                    [[range $years]] 
                        [[if .Bool]]
                            [[$year := .]]
                            [[range $months]] 
